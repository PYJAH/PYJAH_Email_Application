...
public class Server {
	//create a global direcotry 
	static String folderDicretory="/Users/nathan/Desktop/UserDatabase/";
	static String userA="Howie";
	static String userB="Yang";
...
*/
   ...
   private void writeToSent(Email email){
	   	String messageTitle = email.getSubject()+".txt";
		//File userMessage= new File(folderDicretory+"/"+userA+"/"+"Sent/"+messageTitle);
		
	   	String usernameTemp=email.getSender();
	   	
	   	if(!usernameTemp.equals(userA)) {
	   		usernameTemp=userB;
	   	}
	   	
	   	
	   	
	   	File userMessage= new File(folderDicretory+usernameTemp+"/Sent/"+messageTitle);
	   	
		
		try (PrintWriter output = new PrintWriter(userMessage);){
			
			
			
			output.println("Subject: "+email.getSubject());
			output.println("Message: "+email.getBody());
   ...
   private void writeToInbox(Email email){
	   String messageTitle = email.getSubject()+".txt";
		//File userMessage= new File(folderDicretory+"/"+userA+"/"+"Sent/"+messageTitle);
	   	...
	   	File userMessage= new File(folderDicretory+usernameTemp+"/Inbox/"+messageTitle);
